...
'''
Convert SMPL-X json data into `.obj` files.
'''
def main(args):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input-file", default='./mesh-f00021.json', type=str, help="Input folder containing one or multiple smplx json file")
